<template>
  <div class="room-control-container">
    ...
    <header class="room-control-navbar">
      <div class="nav-left">
        <t-button variant="outline" shape="circle" class="back-btn" @click="handleLeaveLive" title="返回列表">
          <template #icon><ArrowLeftIcon /></template>
        </t-button>
        <h1>直播间详情</h1>
      </div>
      <div class="nav-right">
        <t-button variant="text" theme="danger" @click="handleBanRoom">
    ...
    <main class="room-control-viewport">
      ...
      <aside class="right-sidebar">
        ...
        <div class="sidebar-interaction-card">
          <t-tabs v-model="activeTab" class="interaction-tabs">
            <t-tab-panel value="chat" label="消息列表" />
    <t-tab-panel value="audience" label="观众列表" />
          </t-tabs>
        ...
        <div class="sidebar-stats-card">
          <div class="stats-card-header">
            ...
            <div class="refresh-control-inline">
              ...
              <t-select v-model="refreshInterval" :options="refreshOptions" size="small" style="width: 100px" />
            </div>
          </div>
          ...
          <div class="stats-grid-design">
            <div class="stat-item">
              <div class="stat-label">
                直播时长
                <t-popup content="自直播间创建至当前的实时累计时长" placement="top">
            ...
            <div class="stat-item">
              <div class="stat-label">
                实时在线人数
                <t-popup content="实时在线的观众人数" placement="top">
                  <InfoCircleIcon class="info-icon" />
                </t-popup>
              </div>
            ...
            <div class="stat-item">
              <div class="stat-label">
                总评论数
                <t-popup content="直播间累计收到的评论总数" placement="top">
                  <InfoCircleIcon class="info-icon" />
                </t-popup>
              </div>
            ...
            <div class="stat-item">
              <div class="stat-label">
                打赏总金额
                <t-popup content="直播期间所有用户赠送礼物的累计金额" placement="top">
                  <InfoCircleIcon class="info-icon" />
                </t-popup>
              </div>
            ...
            <div class="stat-item">
              <div class="stat-label">
                打赏次数
                <t-popup content="直播期间礼物赠送的总次数" placement="top">
                  <InfoCircleIcon class="info-icon" />
                </t-popup>
              </div>
            ...
            <div class="stat-item">
              <div class="stat-label">
                打赏人数
                <t-popup content="直播期间赠送过礼物的独立用户数" placement="top">
                  <InfoCircleIcon class="info-icon" />
                </t-popup>
              </div>
    ...
    <!-- 已禁言观众弹框 -->
    <t-dialog
      v-model:visible="mutedModalVisible"
      header="已禁言观众"
      :width="600"
      :footer="false"
    >
            ...
            <tr v-for="item in mutedList" :key="item.userId">
              <td class="member-table-user">
                <div class="member-table-user-cell">
                  ...
                  />
                  <Tooltip :content="getUserNameFromCache(item.userId)" placement="top" :show-arrow="false">
                    <span class="member-table-user-name">{{ getUserNameFromCache(item.userId) }}</span>
                  </Tooltip>
                </div>
              </td>
              ...
              <td class="member-table-action">
                <t-button variant="text" theme="primary"  @click="handleUnmuteFromList(item.userId)">
    ...
    <!-- 已封禁观众弹框 -->
    <t-dialog
      v-model:visible="bannedModalVisible"
      header="已封禁观众"
      :width="600"
      :footer="false"
    >
        ...
        <table v-else class="member-list-table">
          ...
          <tbody>
            <tr v-for="item in bannedList" :key="item.userId">
              ...
              <td class="member-table-action">
                <t-button variant="text" theme="primary" shape="round" @click="handleUnbanFromList(item.userId)">
                  解除封禁
                </t-button>
              </td>
            </tr>
    ...
    <t-dialog
      ...
      :confirm-btn="{ content: '确认', theme: 'primary', shape: 'round' }"
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <UserCheckedIcon v-if="isUserBanned(audienceDropdown?.userId || '')" />
          <UserBlockedIcon v-else />
...
import { StopCircleIcon, MoreIcon, ChatOffIcon, InfoCircleIcon, ArrowLeftIcon, UserBlockedIcon, UserCheckedIcon, CheckCircleIcon } from 'tdesign-icons-vue-next';
...
const handleBanRoom = () => {
  ...
  confirmAction.value = async () => {
    ...
    try {
      ...
      MessagePlugin.success('该直播间已被强制关播');
