    ...
    <div class="image-upload-container">
        ...
        <template v-if="uploadEnabled && !urlInputMode">
            ...
            <div v-else class="image-upload-dropzone" :class="{ uploading: uploading }"
                ...
                <template v-else>
                    <Image :size="32" :stroke-width="1.2" />
        ...
        <n-modal
            ...
            :mask-closable="false"
            @update:show="(show: boolean) => { if (!show) closeCropModal(); }"
        >
            ...
            <div class="image-crop-footer">
                <n-button ghost round @click="closeCropModal">取消</n-button>
                <n-button type="primary" round :disabled="imageLoading || !cropImageSrc" @click="handleCropConfirm"
...
import { Upload, X, Scissors, Image } from 'lucide-vue-next';
...
.crop-confirm-btn :deep(.n-button__content) {
    display: flex;
    align-items: center;
}
</style>
